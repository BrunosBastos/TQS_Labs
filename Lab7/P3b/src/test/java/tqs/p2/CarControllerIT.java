...
public class CarControllerIT {
    ...
    void testGetValidCarDetails() {
        ...
        ResponseEntity<Car> entity = restTemplate.getForEntity("/cars/1", Car.class);

        assertThat(entity.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(entity.getBody()).extracting(Car::getName).isEqualTo("bmw");
    }
